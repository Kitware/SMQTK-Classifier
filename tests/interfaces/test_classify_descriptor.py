...
class DummyClassifier (ClassifyDescriptor):  # pragma: no cover
...
class TestClassifierAbstractClass (unittest.TestCase):
    ...
    def test_classify_elements_missing_vector(self) -> None:
        ...
        elems = [
            DescriptorMemoryElement(0).set_vector(np.asarray([1, 2, 3])),
            DescriptorMemoryElement(0),  # no set vector
            DescriptorMemoryElement(0).set_vector(np.asarray([4, 5, 6])),
        ]
    ...
    def test_classify_elements_impl_over_generates(self) -> None:
        ...
        classifications relative to input descriptors."""
        elems = [
            DescriptorMemoryElement(i).set_vector(np.asarray(v))
    ...
    def test_classify_elements_mixed_precomp(self) -> None:
        ...
        for i in range(8):
            de = DescriptorMemoryElement(i).set_vector(np.asarray([i]))
    ...
    def test_classify_elements_batching_effect(self) -> None:
        ...
        d_elems = [
            DescriptorMemoryElement(i).set_vector(np.asarray([i]))
            for i in range(29)
        ]
